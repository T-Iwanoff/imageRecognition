...
class NextMove:
    def __init__(self, next_ball=None, move_type=None, robot_coords=None, robot_heading=None, extra_point=None):
        ...
        self.extra_point = extra_point if extra_point is not None else []
