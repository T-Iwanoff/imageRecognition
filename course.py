...
class Course:
    def __init__(self, ball_coords=None, orange_ball=None, obstacle_coords=None, wall_coords=None, robot_coords=None, robot_heading=None, ball_types=None):
        ...
        self.robot_heading = robot_heading if robot_heading is not None else None
        self.ball_types = ball_types if ball_types is not None else []
